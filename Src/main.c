...
/* USER CODE BEGIN PV */
char data_kirim_usart1[5] = {'i', 't', 's'};
char data_kirim_usart2[11] = {'i', 't', 's'};
char data_kirim_usart6[3] = {'i', 't', 's'};
char data_terima_usart2[4];
char data_terima_usart1[4];
char data_terima_usart6[4];
short int angka_kirim = 0;
/* USER CODE END PV */
